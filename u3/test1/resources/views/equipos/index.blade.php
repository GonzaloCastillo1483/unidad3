        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4 order-first order-lg-last">
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- errores--> <!--en la doc de laravel ir a validation display error y copiar esta parate para que muestre el mensaje-->
                        ...
                        <form method="POST" action="{{route('equipos.store')}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="nombre" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{old('nombre')}}"> <!--el error sirve como un if para activar el is-invalid-->
                            </div>
                            <div class="mb-3">
                                <label for="entrenador" class="form-label">Entrenador</label>
                                <input type="text" id="entrenador" name="entrenador" class="form-control  @error('entrenador') is-invalid @enderror" value="{{old('entrenador')}}"> <!--El old sirve pa tomar el ultimo dato ingresado-->
                            </div>
